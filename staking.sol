...
contract Staking is Ownable{
    ...
    uint256 deductionPercentage=20;
    ...
    function harvest(uint256 [] memory _index) public 
    {
        ...
        depositetime[msg.sender][_index[z]] = 0;
            ...
            if(allocation[lockabledays[msg.sender][_index[z]]]==25){
                uint256 ab = 360 days;
            uint256 bb = (depositeToken[msg.sender][_index[z]])/ab;
          uint256 c =(block.timestamp-depositetime[msg.sender][_index[z]])*bb;
          if(c<=0){
             c=0;
          }
        Users[msg.sender].WithdrawAbleReward += c;
            }
             if(allocation[lockabledays[msg.sender][_index[z]]]==2){
                uint256 ab = 1 days;
            uint256 bb = (depositeToken[msg.sender][_index[z]])/ab;
          uint256 c =(block.timestamp-depositetime[msg.sender][_index[z]])*bb;
          if(c<=0){
        ...
        Users[msg.sender].WithdrawAbleReward += c;
             ...
             if(allocation[lockabledays[msg.sender][_index[z]]]==14){
                uint256 ab = 30 days;
            uint256 bb = (depositeToken[msg.sender][_index[z]])/ab;
          uint256 c =(block.timestamp-depositetime[msg.sender][_index[z]])*bb;
          if(c<=0){
        ...
        Users[msg.sender].WithdrawAbleReward += c;
             ...
             if(allocation[lockabledays[msg.sender][_index[z]]]==17){
                uint256 ab = 90 days;
            uint256 bb = (depositeToken[msg.sender][_index[z]])/ab;
          uint256 c =(block.timestamp-depositetime[msg.sender][_index[z]])*bb;
          if(c<=0){
        ...
        Users[msg.sender].WithdrawAbleReward += c;
             ...
             if(allocation[lockabledays[msg.sender][_index[z]]]==20){
                uint256 ab = 180 days;
            uint256 bb = (depositeToken[msg.sender][_index[z]])/ab;
          uint256 c =(block.timestamp-depositetime[msg.sender][_index[z]])*bb;
          if(c<=0){
        ...
        Users[msg.sender].DepositeToken -= depositeToken[msg.sender][_index[z]];
        uint256 a =(depositeToken[msg.sender][_index[z]])*deductionPercentage/100;
